...
import { BinOP, Num, UnaryOP, Assign, Var, Str, Print, Goto, Abs, Atn } from "../ast/ast";
...
export class Interpreter {
  ...
  protected visit(node: Num | BinOP | UnaryOP | Var | Assign | Str | Print | Goto | Abs | Atn): number | void | string {
